<?php
$directory = 'https://users.sussex.ac.uk/jcb54assignment/application/assets/images/gallery_images';
$imagePath = 'https://users.sussex.ac.uk/jcb54assignment/application/assets/images/gallery_images';
